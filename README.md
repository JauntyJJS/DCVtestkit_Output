...
- [GNU software development
  ...
  like - [RTools](https://cran.rstudio.com/bin/windows/Rtools/) for
  Windows -
  [Xcode](http://itunes.apple.com/us/app/xcode/id497799835?mt=12) for
  Mac - `r-base-dev` for Linux

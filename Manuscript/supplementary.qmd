...
statistical_summary <- lancer::summarise_dilution_data(
  linear_data, 
  "conc_var", 
  "signal_var")
...
# Model the data
linear_model <- lancer::create_linear_model(saturated_data, 
                                                "conc_var", "signal_var")
quad_model <- lancer::create_quad_model(saturated_data, 
                                            "conc_var", "signal_var")
...
# Model the data
linear_model <- lancer::create_linear_model(lod_data, 
                                                "conc_var", "signal_var")
quad_model <- lancer::create_quad_model(lod_data, 
                                            "conc_var", "signal_var")

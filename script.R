## Do note that pressing the source button
## will not create the `index.html` file when the
## function `view_trellis_html` is called.

## This is because the `index.html` file can only
## be created in an interactive R session

## Please call the function using the R console
...
# Call this function via console
# Pressing source button will not create the index.html file
